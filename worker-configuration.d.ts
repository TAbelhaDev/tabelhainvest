/* eslint-disable */
// Generated by Wrangler by running `wrangler types --env-file=.dev.vars.example` (hash: 9fbf6d991a446a42b6b39e95c81c5726)
// Runtime types generated with workerd@1.20260825.1 2026-08-01 nodejs_compat
interface __BaseEnv_Env {
	SESSIONS: KVNamespace;
	DB: D1Database;
	ASSETS: Fetcher;
	ORIGIN: "https://tabelainvest.ianptkcs-023.workers.dev";
	MASTER_KEY: string;
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "ORIGIN" | "MASTER_KEY" | "BETTER_AUTH_SECRET" | "BETTER_AUTH_URL" | "PUBLIC_TABELAUTH_URL" | "PUBLIC_APP_URL" | "REFRESH_TOKEN">> {}
}
