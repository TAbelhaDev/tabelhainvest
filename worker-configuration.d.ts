/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: ec8b5e7f2927c81aad9a1f84aaadbcb0)
// Runtime types generated with workerd@1.20260831.1 2026-08-01 nodejs_compat
interface __BaseEnv_Env {
	SESSIONS: KVNamespace;
	DB: D1Database;
	ASSETS: Fetcher;
	ORIGIN: "https://tabelhainvest.tabelhadev.workers.dev";
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "ORIGIN" | "PUBLIC_TABELHAUTH_URL" | "MASTER_KEY" | "BETTER_AUTH_SECRET" | "BETTER_AUTH_URL" | "PUBLIC_APP_URL">> {}
}
